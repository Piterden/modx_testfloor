<?php /* Smarty version Smarty-3.0.4, created on 2015-12-31 01:25:36
         compiled from "/home/admin/web/yowish.yellowmarker.ru/public_html/core/components/migx/templates/mgr/fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2140366832568459e010e211-14003915%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f3e293ca17de7812465f418ae177f99cf5cdda00' => 
    array (
      0 => '/home/admin/web/yowish.yellowmarker.ru/public_html/core/components/migx/templates/mgr/fields.tpl',
      1 => 1450743508,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2140366832568459e010e211-14003915',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_function_cycle')) include '/home/admin/web/yowish.yellowmarker.ru/public_html/core/model/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_modifier_escape')) include '/home/admin/web/yowish.yellowmarker.ru/public_html/core/model/smarty/plugins/modifier.escape.php';
...
<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['cat']['first']){?>
 ...
 modx-tv" id="tvFormname-tr">
        <label for="tvFormname" class="modx-tv-label">
            <span class="modx-tv-caption" id="tvFormname-caption"><?php echo $_smarty_tpl->getVariable('multiple_formtabs_label')->value;?>
</span>
